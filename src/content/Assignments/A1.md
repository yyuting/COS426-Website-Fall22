...
available: true
# Submission url
submitURL: "https://tigerfile.cs.princeton.edu/COS426_F2022/A1"
# Gallery url
galleryID: "A1"
# Feedback url
feedbackURL: ""
...
### (1.0) Median Filter
`medianFilter(image, winR)` blurs an image and removes speckle noise by replacing each pixel with the median of its neighbors. We define a pixel's neighborhood as a square window of side-length `2 * winR + 1` that is centered at the pixel.
